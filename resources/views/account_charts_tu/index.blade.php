    ...
    <div class="container-fluid">
        <div class="animated fadeIn">
             ...
             <span class="pull-left">
                <a href="{!! route('accountCharts.index') !!}" class=" btn btn-info btn-lg  btn-header">ผังบัญชี Tu-Acc</a>
                <a  href="{!! route('accountChartsTu.index') !!}" class=" btn btn-info btn-lg  btn-header active">ผังบัญชี มธ</a>
            </span>
                ...
                <div class="col-md-12" id="main-index">
                    ...
                    <div class="row ">
                        <div class="col-md-7 col-sm-6">
                                {{-- search --}}
                                @include('account_charts_tu.search')
                                {{-- endsearch --}}
                        ...
                        <div class="col-md-5 text-right col-sm-6">
                            ...
                            <a class="" href="{{ url('accTu/export') }}"><span> <img src="{{ url('/img/icon/excel.png') }}" alt=""></span></a>
                            
                        </div>
                    </div>

                    @include('account_charts_tu.index_tree')
                    <br/>
                    ...
                    <div class="collapse" id="acc_data">
                        <div class="mt-5">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="acc_form">
                                        @include('account_charts_tu.fields')
                                    </form>
                                </div>
                            </div>
                        </div>
