...
<div class="form-group row">
    {!! Form::label('chart_code', 'เลขบัญชี:',['class'=>'col-md-4 col-form-label text-right text-danger']) !!}
    <div class="col-md-8">
...
<!-- Nameth Field -->
<div class="form-group row">
    {!! Form::label('nameth', 'ชื่อบัญชี (ไทย)',['class'=>'col-md-4 col-form-label text-right text-danger']) !!}
    <div class="col-md-8">
...
<div class="form-group row">
    ...
    <div class="col-md-8">
        {!! Form::select('chartcate_type',['BANK'=>'BANK','AR'=>'AR',
        'OCASSET'=>'OCASSET','AP'=>'AP','OCLIAB'=>'OCLIAB',
        'EQUITY'=>'EQUITY','INC'=>'INC','COGS'=>'COGS','EXP'=>'EXP','NONPOSTING'=>'NONPOSTING'], null, ['class' => 'form-control']) !!}
        {{-- <span class="help-block">This is a help text</span> --}}
    </div>
</div>
...
<!-- Accgroupid Field -->
<div class="form-group row">
    {!! Form::label('mapid', 'เชื่อมกับผัง',['class'=>'col-md-4 col-form-label text-right']) !!}
    <div class="col-md-8 text-right">
        {!! Form::text('mapid', null, ['class' => 'form-control']) !!}
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ChartTuModal">
            เลือก
          </button>
        {{-- <button id="chart_tu" type="button" class="btn btn-info"></button> --}}
        {{-- <span class="help-block">This is a help text</span> --}}
    </div>
</div>
