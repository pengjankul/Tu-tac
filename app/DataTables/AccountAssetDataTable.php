...
class AccountAssetDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'account_assets.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\AccountAsset $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(AccountAsset $model)
    {
    ...
    {
        return [
            'asset_code' => ['width' => '10%', 'title' => 'รหัสสินทรัพย์', 'name' => 'asset_code', 'data' => 'asset_code'],
            'nameth' => ['width' => '40%', 'title' => 'ชื่อสินทรัพย์', 'name' => 'nameth', 'data' => 'nameth'],
            'nameen' => ['width' => '40%', 'title' => 'ชื่อสินทรัพย์ (EN)', 'name' => 'nameen', 'data' => 'nameen'],
            'save_status' => ['width' => '10%', 'title' => 'สถานะ', 'name' => 'save_status', 'data' => 'save_status'],
            'datetime_add' => ['width' => '10%', 'title' => 'วันที่เพิ่ม', 'name' => 'datetime_add', 'data' => 'datetime_add'],
            'user_add' => ['width' => '10%', 'title' => 'ผู้เพิ่ม', 'name' => 'user_add', 'data' => 'user_add'],
            'datetime_update' => ['width' => '10%', 'title' => 'วันที่ล่าสุด', 'name' => 'datetime_update', 'data' => 'datetime_update'],
            'user_update' => ['width' => '10%', 'title' => 'ผู้ทำรายการ', 'name' => 'user_update', 'data' => 'user_update'],
        ];
    }
    ...
    {
        return 'account_assetsdatatable_' . time();
    }
}
