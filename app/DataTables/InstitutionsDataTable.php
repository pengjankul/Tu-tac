...
class InstitutionsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'institutions.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\Institutions $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Institutions $model)
    {
    ...
    protected function getColumns()
    {
        return [
            ...
            'instcode' => ['width' => '10%', 'title' => 'รหัสผู้ว่าจ้าง', 'name' => 'instcode', 'data' => 'instcode'],
            'nameth' => ['width' => '40%', 'title' => 'ชื่อผู้ว่าจ้าง', 'name' => 'nameth', 'data' => 'nameth'],
    ...
    {
        return 'institutionsdatatable_' . time();
    }
}
