 ...
 */
class AccountChartTu extends Model
{

    public $table = 'account_chart_tu';
    ...
    public function parent()
    {
        ...
        return $this->belongsTo('App\Models\AccountChartTu', 'achart_parent_id');
    ...
    public function children()
    {
        ...
        return $this->hasMany('App\Models\AccountChartTu', 'achart_parent_id', 'achart_id')->select(['achart_id', 'achart_parent_id', 'achart_id as id', 'nameth as text'])->with('children');
